  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        ...
        />
        {/* <DrawerItemRow
          label="Accepted Screen"
          icon="info"
          {...{ ...props, translateX }}
          onpress={() => props.navigation.navigate('AcceptedScreen')}
        /> */}
        <DrawerItemRow
          label="TripList"
          icon="map"
        ...
        <DrawerItemRow
          ...
          icon="info"
          {...{ ...props, translateX }}
          onpress={() => props.navigation.navigate('CreateSchedule')}
        /> */}
        <DrawerItemRow
          label="Delivery"
          icon="verified"
        ...
        {/* <DrawerItemRow
          ...
          icon="info"
          {...{ ...props, translateX }}
          onpress={() => props.navigation.navigate('TrackingView')}
        /> */}
